...
export const productFormSchema = z.object({
  name: z.string().min(1, { message: 'Tên nông dân không được bỏ trống' }),
  nameJP: z.string(),
  nameFarm: z.string(),
  nameFarmJP: z.string(),
  state: z.any(),
  ward: z.any(),
  address: z.string(),
  shortIntroduce: z.string(),
  shortIntroduceJP: z.string(),
  avatar: z.any(),
  gallery: z.any(),
  video: z.any(),
  category: z.any(),
  categoryJP: z.any(),
  rating: z.any(),
  aboutFarmTitle: z.string(),
  aboutFarmTitleJP: z.string(),
  aboutFarmContent: z.string(),
  aboutFarmContentJP: z.string(),
  whyTitle: z.string(),
  whyTitleJP: z.string(),
  whyContent: z.any(),
  whyContentJP: z.any(),
